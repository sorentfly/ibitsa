...
class Zend_Form_Element implements Zend_Validate_Interface
{
     ...
     * @return Zend_Form_Element
     */
    public function addDecorator($decorator, $options = null, $before = null)
    {
        ...
        if ($before){
            $index = array_search($before,array_keys($this->_decorators));
            $this->_decorators = array_slice($this->_decorators, 0, $index, true) + [$name => $decorator] + array_slice($this->_decorators, $index, NULL, true);
        }else{

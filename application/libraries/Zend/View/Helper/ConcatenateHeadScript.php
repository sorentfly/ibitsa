...
class Zend_View_Helper_ConcatenateHeadScript extends Zend_View_Helper_HeadScript
{
    /**
     * Uri to filepath map
     *
    ...
    public function __construct()
    {
        ...
        $this->map = array('/application/modules/Core/externals/scripts/' => '/application/modules/Core/externals/scripts/');

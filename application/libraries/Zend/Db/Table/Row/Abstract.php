 ...
 * * @property int|mixed repost_id
 * * @property int parent_id
 * * @property string parent_type
 * * @property string division_order
 * * @property int division_order
 * * @property int is_blocked
 * * @property false|string modified_date
 * * @property false|string creation_date
...
abstract class Zend_Db_Table_Row_Abstract implements ArrayAccess, IteratorAggregate
{
    ...
    {
        // Modified by Webligo Developments
        // Skipping column transform
    ...
    protected function _doInsert()
    {
        ...
        // Moved here by Webligo Developments
        $this->_postInsert();

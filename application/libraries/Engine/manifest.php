...
return array(
  'package' => array(
    ...
    'changeLog' => array(
      '4.8.7' => array(
        'Form/Email.php' => 'Fixed fatal error coming on websites (having PHP version > 5.4.0) after upgrading their websites to 4.8.6.',
        'manifest.php' => 'Incremented version',
        'Package/Installer/Module.php' => 'Added code to create a new file to keep track of enabled modules\' directory names',
        'Payment/Gateway/2Checkout.php' => 'Added 2 currencies (Turkish Lira and Russian Ruble)',
        'Payment/Gateway/PayPal.php' => 'Fixed issue with recurring subscriptions via PayPal, that was coming because of IPN Validations getting failed and added 2 currencies (Turkish Lira and Russian Ruble)',
        'Payment/Gateway/Testing.php' => 'Added 2 currencies (Turkish Lira and Russian Ruble)',
        'Service/PayPal.php' => 'Fixed compatibility issue with PayPal coming because of discontinued support to SSL 3.0.'
      ),
      '4.8.6' => array(
        'Form/Email.php' => 'Added',
        'manifest.php' => 'Incremented version',
        'String.php' => 'Added str_random method',
      ),
      '4.8.5' => array(
        'Payment/Gateway.php' => 'Fixed an undeclared variable in Engine_Payment_Gateway::setRegion()',
        'Service/2Checkout.php' => 'Fixed undeclared variables in Engine_Service_2Checkout',
      ),
      '4.8.3' => array(
        'File/Archive/Gzip.php' => 'Fixed a typo in archive insert functions',
        'File/Archive/Bzip2.php' => 'Fixed a typo in archive insert functions',
        'File/Diff/Result.php' => 'Removed unused function _procResult',
        'Package/Utilities.php' => 'Removed deprecated functions',
        'Package/Manifest/Entity/Package.php' => 'Removed unused functions: setTest and getFile',
        'Package/Manifest/Parser/Xml.php' => 'Corrected variable name in fromString',
        'Registry.php' => 'Fixed incorrect variable name in get',
        'Entity/Arbiter.php' => 'Removed unused class',
        'Application/Module/Api.php' => 'Fixed undeclared $identity variable',
      ),
      '4.8.2' => array(
        'Db/Export.php' => 'Fixed an incorrect call to sprintf',
        'Db/Table.php' => 'Removed inaccessible code',
        'File/Diff3.php' => 'Fixed an incorrect call to sprintf',
        'Package/Manager.php' => 'Removed deprecated code',
      ),
      '4.8.0' => array(
        '*' => 'Minor changes for integration with other updates',
      ),
      '4.7.0' => array(
        'View/Helper/TinyMce.php' => 'Upgraded for TinyMCE v4',
        'manifest.php' => 'Incremented version',
      ),
      '4.8.3' => array(
        'View/Helper/ViewMore.php' => 'Fixed issue wither Internet Explorer <= 9',
        'manifest.php' => 'Incremented version',
      ),
      '4.5.0' => array(
